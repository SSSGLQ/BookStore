      	...
      	<table width="60%">
			<tr>  
				<td bgcolor="#F7FEFF" colspan="4">
			 		订单号：${o.ordernum}<INPUT TYPE="hidden" NAME="orderid" value="${o.ordernum}"> 
			 		支付金额：${o.price }<INPUT TYPE="hidden" NAME="money" size="6" value="0.01" >元
			 	</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
			...
			<tr>
			  ...
			  <td><INPUT TYPE="radio" NAME="pd_FrpId" value="BJRCB-NET">北京农村商业银行 </td>
			  <td><INPUT TYPE="radio" NAME="pd_FrpId" value="CBHB-NET">渤海银行</td>
			  <td><INPUT TYPE="radio" NAME="pd_FrpId" value="GDB-NET">广东发展银行</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
